...
from app.models.hr import Department, Designation, Employee, EmployeeDocument, Holiday, EmployeeResume
...
__all__ = [
    "Role", "User", "EmailVerificationToken", "RefreshToken", "PasswordResetToken", "Department", "Designation", "Employee", "EmployeeDocument", "Holiday", "EmployeeResume",
